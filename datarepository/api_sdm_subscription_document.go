...
func HTTPModifysdmSubscription(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Patch /subscription-data/:ueId/context-data/sdm-subscriptions/:subsId is not implemented")
...
func HTTPQuerysdmSubscription(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Get /subscription-data/:ueId/context-data/sdm-subscriptions/:subsId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
