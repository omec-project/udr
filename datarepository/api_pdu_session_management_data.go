...
func HTTPCreateOrReplaceSessionManagementData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Put /exposure-data/:ueId/session-management-data/:pduSessionId is not implemented")
...
func HTTPDeleteSessionManagementData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Delete /exposure-data/:ueId/session-management-data/:pduSessionId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
...
func HTTPQuerySessionManagementData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Get /exposure-data/:ueId/session-management-data/:pduSessionId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
