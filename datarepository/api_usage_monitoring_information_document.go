...
func HTTPCreateUsageMonitoringResource(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Put /policy-data/ues/:ueId/sm-data/:usageMonId is not implemented")
...
func HTTPDeleteUsageMonitoringInformation(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Delete /policy-data/ues/:ueId/sm-data/:usageMonId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
...
func HTTPReadUsageMonitoringInformation(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Get /policy-data/ues/:ueId/sm-data/:usageMonId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
