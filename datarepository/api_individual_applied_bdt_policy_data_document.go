...
func HTTPCreateIndividualAppliedBdtPolicyData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Put /application-data/bdtPolicyData/:bdtPolicyId is not implemented")
...
func HTTPDeleteIndividualAppliedBdtPolicyData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Delete /application-data/bdtPolicyData/:bdtPolicyId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
...
func HTTPUpdateIndividualAppliedBdtPolicyData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Patch /application-data/bdtPolicyData/:bdtPolicyId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
