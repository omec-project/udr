...
func HTTPCreateIndividualBdtData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Put /policy-data/bdt-data/:bdtReferenceId is not implemented")
...
func HTTPDeleteIndividualBdtData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Delete /policy-data/bdt-data/:bdtReferenceId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
...
func HTTPReadIndividualBdtData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Get /policy-data/bdt-data/:bdtReferenceId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
...
func HTTPUpdateIndividualBdtData(c *gin.Context) {
	logger.DataRepoLog.Warnln("Handle Patch /policy-data/bdt-data/:bdtReferenceId is not implemented")
	c.String(http.StatusNotImplemented, "501 not implemented")
}
